...
/*/
//--------------------------------------------------------------------
User Function UPDESPEC( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDESPEC" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDESPEC" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'M=MINERAL;V=VEGETAL;A=ANIMAL;O=OUTROS'									, ; //X3_CBOX
	'M=MINERAL;V=VEGETAL;A=ANIMAL;O=OUTROS'									, ; //X3_CBOXSPA
	'M=MINERAL;V=VEGETAL;A=ANIMAL;O=OUTROS'									, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Controlado?'															, ; //X3_TITULO
	'Controlado?'															, ; //X3_TITSPA
	'Controlado?'															, ; //X3_TITENG
	'Controlado'															, ; //X3_DESCRIC
	'Controlado'															, ; //X3_DESCSPA
	'Controlado'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'composicao'															, ; //X3_TITULO
	'composicao'															, ; //X3_TITSPA
	'composicao'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'microbiologi'															, ; //X3_TITULO
	'microbiologi'															, ; //X3_TITSPA
	'microbiologi'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nutricionais'															, ; //X3_TITULO
	'Nutricionais'															, ; //X3_TITSPA
	'Nutricionais'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Manipulacao'															, ; //X3_TITULO
	'Manipulacao'															, ; //X3_TITSPA
	'Manipulacao'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Micromacro'															, ; //X3_TITULO
	'Micromacro'															, ; //X3_TITSPA
	'Micromacro'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSXA, { ;
	'SB5'																	, ; //XA_ALIAS
	'D'																		, ; //XA_ORDEM
	'Qualidadex'															, ; //XA_DESCRIC
	'Qualidade'																, ; //XA_DESCSPA
	'Qualidade'																, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
aAdd( aSXA, { ;
	'SB5'																	, ; //XA_ALIAS
	'E'																		, ; //XA_ORDEM
	'Qualidade'																, ; //XA_DESCRIC
	'Alergenico'															, ; //XA_DESCSPA
	'Alergenico'															, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
aHlpPor := {}
aAdd( aHlpPor, 'Breve descrição do produto.' )
aAdd( aHlpPor, 'Esta informação atende ao item' )
aAdd( aHlpPor, '4-DESCRIÇÃO DO PRODUTO da especificação' )
aAdd( aHlpPor, 'do produto' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB1_XDESC  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XDESC" )
...
aHlpPor := {}
aAdd( aHlpPor, 'Informação de composição do produto.' )
aAdd( aHlpPor, 'Esta informação sairá no item de' )
aAdd( aHlpPor, 'COMPOSIÇÃO DO PRODUTO  na sua' )
aAdd( aHlpPor, 'especificação.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB5_XCOMPOS", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "B5_XCOMPOS" )

aHlpPor := {}
aAdd( aHlpPor, '7.    CARACTERISTICAS MICROBIOLOGICAS' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB5_XMICRO ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "B5_XMICRO" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDESPEC" ) ) ) ;
