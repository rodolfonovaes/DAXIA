...
/*/
//--------------------------------------------------------------------
User Function UPDESP1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDESP1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDESP1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	40																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nome Fabric.'															, ; //X3_TITULO
	'Nome Fabric.'															, ; //X3_TITSPA
	'Nome Fabric.'															, ; //X3_TITENG
	'Nome do Fabricante'													, ; //X3_DESCRIC
	'Nome do Fabricante'													, ; //X3_DESCSPA
	'Nome do Fabricante'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Animal;2=Vegetal;3=Mineral'											, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	'7. CARACTERISTICAS MICROB'												, ; //X3_DESCRIC
	'7. CARACTERISTICAS MICROB'												, ; //X3_DESCSPA
	'7. CARACTERISTICAS MICROB'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Inf. Nutrici'															, ; //X3_TITSPA
	'Inf. Nutrici'															, ; //X3_TITENG
	'Inf. Nutricional'														, ; //X3_DESCRIC
	'Inf. Nutricional'														, ; //X3_DESCSPA
	'Inf. Nutricional'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Campo customizado: Nome do fabricante' )
aAdd( aHlpPor, 'doproduto.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PQEK_XNFABR", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "QEK_XNFABR" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDESP1" ) ) ) ;
