...
oPrint:say(_nPosHor+((_nLinha-1)*_nEspLin)+_nTxtBox+50 ,_nPosVer+0010,"Ap๓s o vencimento, cobrar mora de R$ " + Alltrim(transform(_aTitulos[_nCont][17] * 0.002 ,"@E 999,999,999.99")) + " ao dia.",ofont09,100)
oPrint:say(_nPosHor+((_nLinha-1)*_nEspLin)+_nTxtBox+100 ,_nPosVer+0010,"PROTESTAR APำS 05 DIAS CORRIDOS DO VENCIMENTO",ofont09,100)
