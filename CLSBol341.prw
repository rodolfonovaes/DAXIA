...
*/
	...
	cSql += " SA1.A1_MUNC, SA1.A1_ESTC, SA1.A1_PESSOA, SA1.A1_TIPO, SE1.E1_BARRA "
	...
	While !TMPSE1->( Eof() )
		...
		Else
			AAdd( aItens, { SA6->A6_FILIAL, cBanco, cAgencia, cConta, TMPSE1->E1_FILIAL, TMPSE1->E1_PREFIXO, TMPSE1->E1_NUM, TMPSE1->E1_PARCELA, TMPSE1->E1_TIPO, xFilial("SA1")} )
		EndIf
		TMPSE1->( DbSkip() )
	End
