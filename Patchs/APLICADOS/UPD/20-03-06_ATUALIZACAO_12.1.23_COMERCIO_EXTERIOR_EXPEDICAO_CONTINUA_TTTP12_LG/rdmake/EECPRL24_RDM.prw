...
Begin Sequence
   ...
   DEFINE MSDIALOG oDlg TITLE cTitRpt FROM 1,1 TO /*203*/233,/*273*/323 OF oMainWnd PIXEL //FDR - 16/01/12 - Ajuste de tela
      ...
      if lNovaRotina                                      
         @ 37,8  SAY STR0012 PIXEL //"Situação :"
         @ 35,38 COMBOBOX oCbxSit VAR cSituacao ITEMS aSituacao  SIZE 90,8 ON CHANGE (fChange()) OF oDlg PIXEL  
      
         @ 50,8  SAY STR0013  PIXEL //"Dt. Aprov. :"
         @ 48,38 MSGET oDtIni VAR dDtIni SIZE 40,8 PIXEL   
      
         @ 50,78 SAY STR0014 PIXEL //"Até "
         @ 48,88 MSGET oDtFim VAR dDtFim SIZE 40,8 PIXEL  
         fChange()  
      Endif
      
      @ 63-n,8  SAY STR0015 PIXEL //"Produto : "
      @ 61-n,38 MSGET cProduto PICTURE "@!" F3 "EB1" Valid (Empty(cProduto) .or. ExistCPO("SB1")) SIZE 40,8 OF oDlg PIXEL 
      
      @ 76-n,8  SAY STR0016 PIXEL //"País : "
      @ 74-n,38 MSGET cPais PICTURE "@!" F3 "SYA" Valid (Empty(cPais) .or. ExistCPO("SYA")) SIZE 40,8 OF oDlg PIXEL 
         
      @ 89-n,8  SAY STR0017 PIXEL //"Cliente :"
      @ 87-n,38 MSGET cCliente F3 "CLI" Valid (Empty(cCliente) .or. ExistCPO("SA1")) SIZE 40,8 OF oDlg PIXEL   
      
      @ 102-n,8  SAY STR0018 PIXEL //"Moeda : "
      @ 100-n,38 MSGET cMoeda PICTURE "@!" F3 "SYF" Valid (Empty(cMoeda) .or. ExistCPO("SYF")) SIZE 40,8 OF oDlg PIXEL 
