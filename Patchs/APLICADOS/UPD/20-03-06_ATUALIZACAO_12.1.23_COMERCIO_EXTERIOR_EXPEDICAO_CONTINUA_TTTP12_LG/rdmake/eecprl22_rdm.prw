...
Begin Sequence
   ...
   #ELSE
      ...
      IndRegua("Qry",cWork+TEOrdBagExt(),"EXM_PREEMB","AllwayTrue()","AllwaysTrue()","Processando Arquivo Temporario")
...
Begin Sequence
   ...
   Define MsDialog oDlg Title STR0011 From 0,0 To 195,316 Of oMainWnd Pixel //"Relatório de Pré-Calculo"
      ...
      @ 40,015 Say AvSx3("EXM_PREEMB",AV_TITULO) Pixel Of oDlg
      @ 40,050 MsGet oProcesso Var cProcesso Picture AvSx3("EXM_PREEMB",AV_PICTURE);
                                     Size 070,08;
                                     Valid (Prl22Vld("PROCESSO"));
                                     F3 "EEC" Pixel Of oDlg

      @ 52,015 Say AvSx3("EX6_CLIENT",AV_TITULO) Pixel Of oDlg
      @ 52,050 MsGet oCodClient Var cCodClient Picture AvSx3("EEC_CLIENT",AV_PICTURE);
                                            Size 045,08;
      ...
      @ 64,015 Say AvSx3("EXM_DESP",AV_TITULO) Pixel Of oDlg
      @ 64,050 MsGet oCodDesp Var cCodDesp Picture AvSx3("EXM_DESP",AV_PICTURE);
                                           Size 045,08;
