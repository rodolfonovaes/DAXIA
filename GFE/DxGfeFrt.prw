...
IF !empty(("TMP1")->CK_PRODUTO)
	While !Eof()
		If  !("TMP1")->CK_FLAG .And. !Val(TMP1->CK_XMOTIVO) > 1
			TMP1->CK_XVLFRET := nValor * (TMP1->CK_QTDVEN / nTotQtd )
			U_ClcComis()

			If TMP1->(Recno()) == nLinha
