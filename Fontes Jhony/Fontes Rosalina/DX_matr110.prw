	...
	//Incluida validação para os pedidos de compras por item do pedido  (IP/alçada)			
		...
		If !lNewAlc
			...
			If SC7->C7_TIPO == 1 .OR. SC7->C7_TIPO == 3
				oReport:PrintText("Recebimentos: Seg a Sex - 08:00 as 15:30hs; acima de 10 tons até as 12:00hs; granel chegar as 08:00hs. Validade do produto no máx. 50% do seu total; ",,050 )
				oReport:PrintText("Pagamentos as Terças e Quintas. Produto Importado deve vir na embalagem original e Laudo original do fabricante. Informar o número desta OC em sua Nota Fiscal.",,050 ) 
			Else
