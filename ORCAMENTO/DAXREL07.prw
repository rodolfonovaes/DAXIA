...
cQuery := "SELECT DISTINCT W2_PO_NUM AS PO , W2_FRETNEG AS FRETNEG, W6_XFT AS FREETIM ,W2_NR_PRO AS DOC ,F1_RECBMTO, W2_FORLOJ AS LOJA, W6_DT_ENTR,W7_II AS II ,W2_FORN AS FORNECEDOR ,A2_PAIS AS PAIS,  W6_HOUSE AS HDL , W2_AGENTE AS AGENTE , Y4_NOME ,W6_VLRRECC  AS VLFRETE , B1_DESC AS DESCRICAO , W8_COD_I AS DESCVM , W7_PESO * W7_QTDE AS PESO  "
...
oBrowse:SetColumns(MontaColunas("VLFRETE"	    ,"Valor Frete"		,07,"@!",1,005,0))//9 ANTIGO W9_FRETEIN
