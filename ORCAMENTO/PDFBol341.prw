...
STATIC Function PDFPrinter()
	...
	oPrn:Say( 0460, 0015, "AP”S VENCIMENTO COBRAR JUROS DE R$ " + Alltrim(Transform(nBolValDoc * 0.002 ,"@E 999,999,999.99")), oFont1,100 )
	...
	oPrn:Say( 0710, 0015, "AP”S VENCIMENTO COBRAR JUROS DE R$ " + Alltrim(Transform(nBolValDoc * 0.2 ,"@E 999,999,999.99")), oFont1,100 )
