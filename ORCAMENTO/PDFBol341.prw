...
User Function PDFBOL341(aItens, aLog, nTipoCart)
	...
	SE1->(DbClearFilter())//Limpo o filtro que estava causando errorlog qdo chamava a funÁ„o do boleto do bradesco antes
	...
	For i := 1 To nLen
		...
		// Verifica se o tÌtulo pertence ao banco Ita˙
