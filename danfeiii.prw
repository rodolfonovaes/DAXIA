...
RPTStatus( {|lEnd| U_DanfeDax(@oDanfe, @lEnd, cIDEnt, Nil, Nil, @lExistNFe, lIsLoja)}, "Imprimindo DANFE DAXIA..." )	
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
User Function DanfeDax(	oDanfe	, lEnd		, cIdEnt	, cVal1,;
...
//	nPerDesc	:= ((nDesc*100)/nVTotal)
	...
	Else*/
		...
		//Rodolfo
		aadd(aItensAux2,{;
			oDet[nX]:_Prod:_cProd:TEXT + SD2->D2_LOTECTL ,;
			SubStr(NoChar(oDet[nX]:_Prod:_xProd:TEXT,lConverte),1,nMaxDes),;
			IIF(Type("oDet[nPrivate]:_Prod:_NCM")=="U","",oDet[nX]:_Prod:_NCM:TEXT),;
			cSitTrib,;
			oDet[nX]:_Prod:_CFOP:TEXT,;
